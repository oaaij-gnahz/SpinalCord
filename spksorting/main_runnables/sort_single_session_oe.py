...
if __name__=="__main__":
    # rawfolder_root = "/media/hanlin/Liuyang_10T_backup/jiaaoZ/data/BenMouse0"
    # mdafolder_root = "/media/hanlin/Liuyang_10T_backup/jiaaoZ/data_converted/BenMouse0"
    resfolder = "/media/hanlin/Liuyang_10T_backup/jiaaoZ/msort_results/BenMouse0"
